        ...
        switch ($this->post['action_mu_mode']) {
            ...
            case DUPX_MultisiteMode::Subdirectory:
                ...
                foreach ($subsitesIds as $currentSubid) {
                    ...
                    $priority = ($isMainSite) ? DUPX_UpdateEngine::SR_PRORITY_GENERIC_SUBST : DUPX_UpdateEngine::SR_PRORITY_NETWORK_SUBSITE;
            ...
            case DUPX_MultisiteMode::Standalone:
                ...
                if ($subsite_id == 1) {
                    ...
                    $s_r_manager->addItem($uploadsDirSubOld, $uploadsNew, DUPX_S_R_ITEM::TYPE_PATH_UNTRAILINGSLASHIT, DUPX_UpdateEngine::SR_PRORITY_NETWORK_SUBSITE_HIGH);
