...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20200302_snowdrop_5a4862fc6b58f9388450_20200302000144_archive.zip';
    const ARCHIVE_SIZE       = '67300941';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '5a4862f-02000144';
    const VERSION            = '3.8.7';
