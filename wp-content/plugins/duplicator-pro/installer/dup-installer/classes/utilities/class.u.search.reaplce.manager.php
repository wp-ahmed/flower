...
class DUPX_S_R_ITEM
{
    ...
    public static function searchReplacePath($search_path, $replace_path)
    {
         ...
         * 
         */
        $search_path_safe = DupProSnapLibIOU::safePath($search_path);
        if ($search_path_safe != $search_path) {
            $result = array_merge($result, self::searchReplaceWithEncodings($search_path_safe, $replace_path));
        }
