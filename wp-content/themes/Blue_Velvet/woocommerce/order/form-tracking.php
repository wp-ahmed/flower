...
<div class="container" style="padding-top: 75px;">
	<form action="<?php echo esc_url( get_permalink( $post->ID ) ); ?>" method="post" class="checkout-form woocommerce-form woocommerce-form-track-order track_order">
